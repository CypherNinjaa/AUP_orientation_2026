 ...
 * ⚠️ Shell page.
 *
 * Signing in and rendering a real pass needs the backend. Until then this page
 * is the empty state done properly: it says where the pass will be, what it will
 * carry, and what the person scanning it can see — which is the question people
 * actually ask. It deliberately does not mock up a fake pass, because a
 * convincing picture of a credential that does not exist yet is a lie.
 */
  ...
  return (
    <>
        ...
        aside={
          ...
          <div className="border-rule/80 bg-paper-tint/60 rounded-3xl border-2 border-dashed p-7 text-center sm:p-9">
            ...
            <p className="text-ink-soft mx-auto mt-2 max-w-xs text-[0.9375rem] leading-relaxed">
              Once you have registered, sign in on any device and it is on this page — with a button
            ...
            <p className="text-ink-faint mt-5 text-[0.8125rem]">
              Already registered? Sign-in opens with the form.
            </p>
          </div>
        }
      />
      ...
      <CtaBand
        icon="id"
        title="No pass yet?"
        body={`Registering takes about two minutes. Your pass covers ${EVENT.dateRange} and brings one guest with you.`}
      />
    </>
  )
}
